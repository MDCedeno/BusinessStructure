...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../CSS/howpage.css" />
  ...
  <body>
    ...
    <!-- This is the how page section -->
     <section class="how">
      <h1 class="main-header">HOW IT WORKS</h1>
      <div class="tutorial">
        <h1>Make it yours!</h1>
        <h3>Personalize your healthy and budget friendly diet</h3>
        <h4>PERSONALIZE . SHOP . ENJOY</h4>
      </div>
    </section>
      ...
      <div class="content">
        ...
        <div class="box">
          <img
            ...
            class="box-image"
          />
          <h3>SHOP FOR PREPARED MEAL OR INGREDIENTS</h3>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </p>
        ...
        <div class="box">
          <img
            ...
            class="box-image"
          />
          <h3>FOLLOW THE GUIDE FOR RECIPES</h3>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </p>
